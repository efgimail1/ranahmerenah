...
export default function Dashboard() {
  ...
  const statusChartData = [
    ...
    { name: 'Berjalan', value: proj.by_status?.in_progress || 0, fill: '#3b82f6' },
    { name: 'Selesai', value: proj.by_status?.completed || 0, fill: '#10b981' },
    { name: 'Ditahan', value: proj.by_status?.on_hold || 0, fill: '#f59e0b' },
  ]
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">
          Ringkasan proyek & keuangan RanahMerenah
        </p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        <StatCard
          label="Total Proyek"
          value={proj.total || 0}
          sub={`${proj.by_status?.in_progress || 0} berjalan · ${proj.by_status?.completed || 0} selesai`}
          icon={Briefcase}
          color="blue"
        />
        <StatCard
          label="Total Biaya Arsitek"
        ...
        <StatCard
          ...
          sub={`Sisa: ${formatRupiah(fin.total_outstanding)}`}
          icon={TrendingUp}
          color="green"
        />
        <StatCard
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Card className="col-span-1">
          <CardHeader title="Arus Kas Bulan Ini" />
        ...
        <Card className="col-span-2">
          <CardHeader title="Distribusi Status Proyek" />
      ...
      <Card padding={false}>
        <div className="px-5 py-4 border-b border-gray-200">
          <h3 className="text-sm font-medium text-gray-900">Proyek Aktif & Pending</h3>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50">
                <th className="text-left px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide">Proyek</th>
                <th className="text-left px-4 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide">Klien</th>
                <th className="text-left px-4 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide">Nilai RAB</th>
                <th className="text-left px-4 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide">Terkumpul</th>
